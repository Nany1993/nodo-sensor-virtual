# Pipeline IoT: CounterFit + captura 2 h (cada 5 s) + dashboard.
# Ejecutar desde la raiz: .\actividad4\activar_flujo.ps1
...
Write-Host "Sembrando datos de mayo en TimescaleDB..." -ForegroundColor Cyan
& "$root\.venv\Scripts\python.exe" "$root\actividad4\sembrar_datos_mayo.py"

Write-Host "Abriendo 3 terminales (captura 2 h, cada 5 s)..." -ForegroundColor Cyan
